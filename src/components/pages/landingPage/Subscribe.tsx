  ...
  return (
    <section className="subscribe pb-20 overflow-hidden">
      <div className="relative bg-[url('../../public/assets/BgImage.png')] bg-center bg-cover">
        ...
        <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/4 left-0 shine-gradient w-[700px] h-[700px] rounded-full" />
        <div className="absolute top-1/2 -translate-y-1/2 translate-x-1/4 right-0 shine-gradient w-[700px] h-[700px] rounded-full" />
